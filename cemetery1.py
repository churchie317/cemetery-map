...
GOOGLE_SHEET_ID = "1iJ9ZdTm__fVaoqMsahe_whqxlKNsC-7w5L7J1oSi1Cc"
GOOGLE_GID = "889949197"

reference_data_url = f"https://docs.google.com/spreadsheets/d/{GOOGLE_SHEET_ID}/export?format=csv&gid={GOOGLE_GID}"
...
df = pd.read_csv(reference_data_url, index_col=1)
...
def text_rectangle(anchor1, anchor2, label, size, width, height):
    ...
    translat1 = mpl.transforms.Affine2D().translate(0.5, 0)
